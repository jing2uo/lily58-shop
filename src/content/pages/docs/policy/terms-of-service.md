...
description: "Terms for ordering a hand-built Lily58 keyboard — products and orders, Stripe payments, shipping, returns and refunds, and limitation of liability."
---
...
- Please see the [Shipping Policy](/docs/policy/shipping-return/) for details.

## 5. Returns & Refunds

- Please see the [Return Policy](/docs/policy/shipping-return/) for details (refund rules are included there).
